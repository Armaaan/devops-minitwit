# Adapted from session_03/API_Spec/minitwit_sim_api_test.py
# Changed BASE_URL to point to live DigitalOcean server
# Removed local database dependency (our server uses SQLAlchemy ORM)
